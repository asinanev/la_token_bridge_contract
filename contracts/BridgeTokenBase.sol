...
contract BridgeTokenBase is ERC20, ERC20Burnable {
    ...
    function burnFrom(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) public virtual onlyBridge {
        this.permit(owner, spender, value, deadline, v, r, s);
        super.burnFrom(owner, value);
    }

    modifier onlyBridge {
        require(msg.sender == bridge, "only bridge has access");
        _;
    }
}